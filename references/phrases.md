...
| Word | Frequency ratio (AI / human) | Notes |
|------|------------------------------|-------|
| delve | 28× | Single strongest AI signal |
| underscore | 13.8× | |
| showcase | 10.7× | |
| elucidate | 9.4× | |
| navigate (challenges) | 8× | Already in Business Jargon above |
| foster | 7.2× | |
| leverage | 6.8× | |
| harness | 6.1× | |
| illuminate | 5.5× | |
...
| Word | Frequency ratio | Notes |
|------|----------------|-------|
| tapestry | 11.2× | As metaphor: "the tapestry of..." |
| landscape | 8.5× | Already in Business Jargon above |
| paradigm | 7.8× | |
| synergy | 6.4× | |
| ecosystem | 5.9× | |
| realm | 5.3× | |
| cornerstone | 4.8× | |
| testament | 4.5× | "a testament to..." |
| beacon | 4.1× | "a beacon of..." |
| catalyst | 3.7× | |
| underpinning | 3.4× | |
| interplay | 3.2× | |
...
| Word/Phrase | Frequency ratio | Notes |
|-------------|----------------|-------|
| furthermore | 7.1× | |
| moreover | 6.3× | |
| notably | 5.8× | |
| consequently | 4.9× | |
| in conclusion | 4.5× | |
| it is worth noting | 4.2× | Already in Adverbs section above |
| this underscores | 3.8× | |

**Rule:** If your text uses more than 2 words from this list in a single paragraph, rewrite. Each one alone is a mild signal; clustered, they scream "AI."

### Academic Slop Phrases

Tortured phrases and hedging language that spike in AI-generated academic text:
